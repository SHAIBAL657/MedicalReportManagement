<?php
    ...
    if(isset($_POST['login']))
    {
      if((!empty($_POST['hid'])) && (!empty($_POST['password'])) && (!empty($_POST['did'])))
      {
        ...
        $query=mysqli_query($conn,"select * from doctor d,hospital h where d.did='".$did."' and h.hid='".$hid."' and d.password='".$pass."' and h.hid=d.hid") ;
        ...
        if($res)
        {
         ...
         echo "<SCRIPT> //not showing me this
          ...
          window.location.replace('dindex.php');
          </SCRIPT>";
        }
        else
        {
...
<script>
  ...
  <body>
    ...
    <div class="login-box">
      ...
      <p><input type="tel"placeholder="Enter Your DID.."  oninput="this.className = ''" name="did" required></p>
